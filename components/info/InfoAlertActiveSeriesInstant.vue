...
<template>
  ...
  >
    <v-card-text class="pa-0 mb-0" style="word-break: break-word;">
      Diese Frage wird teil der Serie <span v-if="name" class="font-weight-bold">{{ name }}</span>
    </v-card-text>

    <v-expand-transition class="mt-2">
      <div v-show="expand">
        <v-card-text class="pa-0 mb-0" style="word-break: break-word;">
          Diese Frage wird der Fragenserie "{{ name }}" hinzugefügt. Wenn du das nicht möchtest, kannst du einfach auf "Nicht hinzufügen" tippen.
        </v-card-text>
...
export default {
  name: 'InfoAlertActiveSeriesInstant',
